#!/home/lily/lilypond-2.24.0/release/binaries/dependencies/install/Python-3.10.8/bin/python3.10
# -*- coding: utf-8 -*-
...
# is not next to bin/.
sys.path.insert (0, os.path.join ('/home/lily/lilypond-2.24.0/release/binaries/mingw/lilypond/install/share/lilypond/2.24.0', 'python'))
...
gettext.install('lilypond', '/home/lily/lilypond-2.24.0/release/binaries/mingw/lilypond/install/share/locale')
...
lilypond_binary = os.path.join('/home/lily/lilypond-2.24.0/release/binaries/mingw/lilypond/install/bin', 'lilypond')
...
if '/home/lily/lilypond-2.24.0/release/binaries/mingw/lilypond/install/bin' == ('@' + 'bindir@') or not os.path.exists(lilypond_binary):
